...
exports.withShieldConfigurationProvider = void 0;
const config_plugins_1 = require("@expo/config-plugins");
const Xcodeproj_1 = require("@expo/config-plugins/build/ios/utils/Xcodeproj");
const path = __importStar(require("path"));
const EXTENSION_NAME = 'ShieldConfigurationExtension';
const EXTENSION_BUNDLE_ID_SUFFIX = '.shieldconfiguration';
const DEFAULT_BUNDLE_ID = 'com.thomascadle.flicker';
/**
 * Adds the ShieldConfiguration extension target to the Xcode project.
 * This extension provides custom shield UI matching Flicker's dark theme.
 */
const withShieldConfigurationProvider = (config) => {
    return (0, config_plugins_1.withXcodeProject)(config, async (mod) => {
        ...
        const swiftFiles = ['ShieldConfigurationExtension.swift', 'AppGroupStorage.swift'];
...
exports.withShieldConfigurationProvider = withShieldConfigurationProvider;
