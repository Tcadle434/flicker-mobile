...
import { firefliesShaderSource } from '../../shaders/fireflies';
...
export default function FirefliesOverlay({
  ...
  const effect = useMemo(() => Skia.RuntimeEffect.Make(firefliesShaderSource), []);
  ...
  return (
    <Group clip={clipRect}>
      {/* Night dimming — darker than rain for a nighttime feel */}
      <Fill color="rgba(0, 5, 15, 0.22)" />
