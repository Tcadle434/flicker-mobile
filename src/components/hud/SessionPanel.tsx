...
export default function SessionPanel({ visible, onClose }: SessionPanelProps) {
  ...
  const [durationByMode, setDurationByMode] = useState<Record<SessionMode, number>>(INITIAL_DURATIONS);
        ...
        <Animated.View style={[styles.panelWrapper, panelStyle]}>
          <PixelPanel style={styles.panel} inset={10}>
            <View style={[styles.content, { paddingBottom: insets.bottom + 18 }]}>
              ...
              <Text style={styles.subtitle}>Choose your mode, dial in the duration, then begin.</Text>
              ...
              >
                <PixelPanel source={HUD_ASSETS.panelSlice2} scale={1} style={styles.beginButtonPanel}>
                  <View
                    style={styles.beginButtonInner}
                  >
