...
const SPRITESHEET = require("../../../assets/ui/btn_press_enter_tent_spritesheet.png");

// Sprite frame dimensions (same as HudIconButton)
const FRAME_W = 96;
const FRAME_H = 32;
const FRAME_COUNT = 4;
...
// Display size — match HudIconButton
...
export default function EnterTentButton({ onPress, style }: Props) {
