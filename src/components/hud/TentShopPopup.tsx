...
export default function TentShopPopup({ visible, onClose, onSelectItem }: Props) {
  ...
  const panelHeight = SCREEN_H * 0.50;
                ...
                <View style={styles.dropdownMenu}>
                  {CATEGORY_TABS.map((tab) => (
                    <TouchableOpacity
                      ...
                      activeOpacity={0.7}
                      style={[styles.dropdownOption, activeCategory === tab.key && styles.dropdownOptionActive]}
                    >
                      <Text style={[styles.dropdownOptionText, activeCategory === tab.key && styles.dropdownOptionTextActive]}>
                        {tab.label}
                      </Text>
                    </TouchableOpacity>
                  ))}
