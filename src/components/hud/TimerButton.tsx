 ...
 * Same frame layout as StoreButton — the visible button is the center 32×32.
 */
...
const SPRITESHEET = require("../../../assets/ui/btn_press_timer_spritesheet.png");
...
export default function TimerButton({ onPress, style }: Props) {
